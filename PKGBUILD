...
pkgname=('nvidia-utils' 'lib32-nvidia-utils' 'opencl-nvidia' 'lib32-opencl-nvidia' 'nvidia-open-dkms' 'nvidia-settings')
arch=('x86_64')
...
source=('nvidia-drm-outputclass.conf'
        ...
        "nvidia-open-dkms_550.163.01_rtd3.diff"
        "nvidia-open-dkms_550.163.01_6.15.diff"
        "nvidia-open-dkms_550.163.01_6.16.diff")
sha512sums=('de7116c09f282a27920a1382df84aa86f559e537664bb30689605177ce37dc5067748acf9afd66a3269a6e323461356592fdfc624c86523bf105ff8fe47d3770'
            ...
            'df2266dcd941da818353a42ba8296e333f1be3de7df2de6dc5332fc9259b149321789ad26b18290cd9cf67c6a685f5da3e547e924d0a13908812dc7709f3428f'
            ...
            'a53b463ddbb33c0279e7ddf40d2ece8ff0aed0edce4e9e7b8d43f499d0dceaf7aacb34c2ccb7fdb01c5b20040a4c8331dd548cc139ba6a6c614b888133752913'
            '8dac3d871336184da6ff8756ff5652529ac69fec0f98a1b1b14b90a03d6dee55eec7ae31fb30e25352302bc656513303ff7eb4b88f90c9f2737d6d9f8176f78c'
            'b3b12509d531badf794bd160c25979a361641e107fac834f2e0ae6afaae2805df2327070808c6eeee726a0b76f445b876cd546eafb17d404a85b5b5dccc988b8')
...
package_nvidia-open-dkms() {
    ...
    patch -Np1 < "$srcdir"/nvidia-open-dkms_550.163.01_rtd3.diff -d open-gpu-kernel-modules-dkms
    patch -Np1 < "$srcdir"/nvidia-open-dkms_550.163.01_6.15.diff -d open-gpu-kernel-modules-dkms
    patch -Np1 < "$srcdir"/nvidia-open-dkms_550.163.01_6.16.diff -d open-gpu-kernel-modules-dkms
...
package_nvidia-settings() {
    ...
    install -D -m755 "libnvidia-wayland-client.so.${pkgver}" "${pkgdir}/usr/lib/libnvidia-wayland-client.so.${pkgver}"
}
